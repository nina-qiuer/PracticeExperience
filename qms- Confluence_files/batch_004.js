...
Confluence.Templates.User.logo = function(opt_data, opt_sb) {
  ...
  if (opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) {
    output.append('<a ', (opt_data.canView) ? ' class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '', ' href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/zh_CN-1988229788/4215/27aa6aff3fb0e9e5138a84da80ecdaa533a08846.1/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"></a>');
  } else {
    if (opt_data.profilePictureInfo.anonymous) {
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/zh_CN-1988229788/4215/27aa6aff3fb0e9e5138a84da80ecdaa533a08846.1/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml("\u533f\u540d"), '" title="', soy.$$escapeHtml("\u533f\u540d"), '">');
      ...
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/zh_CN-1988229788/4215/27aa6aff3fb0e9e5138a84da80ecdaa533a08846.1/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml(opt_data.username), '" title="', soy.$$escapeHtml(opt_data.username), '">');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.editorLoadErrorMessage = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<p>', soy.$$escapeHtml(opt_data.message), '</p><p><a href="', soy.$$escapeHtml(opt_data.fallbackUrl), '">', soy.$$escapeHtml("\u518d\u6b21\u5c1d\u8bd5"), '</a></p>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.displayCommentEditorCommon = function(opt_data, opt_sb) {
  ...
  output.append('<div class="quick-comment-vertical-spacer"></div><div class="quick-comment-body"><div class="quick-comment-loading-container" style="display:', (opt_data.state == 'loading') ? 'block' : 'none', ';"><p class="quick-comment-loading-message">', soy.$$escapeHtml("\u6b63\u52a0\u8f7d\u7f16\u8f91\u5668"), '</p></div><div id="editor-messages"></div><div id="all-messages"></div><form style="display:', (opt_data.state == 'loading') ? 'none' : 'block', ';" class="quick-comment-form aui" method="post" ');
  ...
  output.append(' ><div title="', soy.$$escapeHtml("\u6dfb\u52a0\u8bc4\u8bba"), '" class="quick-comment-prompt"><span>', soy.$$escapeHtml("\u5199\u8bc4\u8bba\u2026"), '</span></div></form></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_sb) {
  ...
  if (opt_data.userInfo.userName == null) {
    ...
    output.append('<a class="userLogoLink" data-username="', soy.$$escapeHtml(opt_data.userInfo.userName), '" href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/zh_CN-1988229788/4215/27aa6aff3fb0e9e5138a84da80ecdaa533a08846.1/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"></a>');
  } else {
...
Confluence.Templates.Comments.displayComment = function(opt_data, opt_sb) {
  ...
  if (opt_data.comment.parentId == 0 && opt_data.firstReply) {
    output.append('<div id="comments-section" class="pageSection group"><div class="section-header"><h2 id="comments-section-title" class="section-title"><a href="#" class="comments-show-hide comments-showing" name="comments">', soy.$$escapeHtml("\u8bc4\u8bba"), '</a></h2><a title="', soy.$$escapeHtml("\u9690\u85cf/\u663e\u793a\u8bc4\u8bba"), '" href="#" class="comments-show-hide icon comments-showing icon-section-opened">', soy.$$escapeHtml("\u9690\u85cf/\u663e\u793a\u8bc4\u8bba"), '</a>');
...
try {
AJS.toInit(function(a){a(".create-from-template-button").click(function(){var d=a(this),b=Confluence.Blueprint.Dialog.openDialog({showDialog:false,updateHeight:false});var c=d.attr("data-space-key");Confluence.Blueprint.Dialog.requestWebItems(c).done(function(i){var j=Confluence.Blueprint.Dialog.loadedWebitems[c];if(_.isEmpty(j)){return}var e=d.attr("data-blueprint-module-complete-key");var g=d.attr("data-template-id");var f=e?_.find(j,function(k){return k.blueprintModuleCompleteKey==e}):_.find(j,function(k){return k.templateId==g});if(!f){return}var h=f.itemModuleCompleteKey;f=a.extend({},f);f.title=d.attr("data-title");f.spaceKey=c;f.skipHowToUse=true;Confluence.Blueprint.fireWizard(i,f,b);if(Confluence.Blueprint.hasWizard(h,f)){b.show()}});return false})});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
Confluence.Templates.Blueprints.CreateFromTemplate.macroTemplate = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<button class=\'aui-button create-from-template-button\'', (opt_data.title) ? 'data-title=\'' + soy.$$escapeHtml(opt_data.title) + '\'' : '', 'data-space-key=\'', soy.$$escapeHtml(opt_data.spaceKey), '\'', (opt_data.templateId) ? 'data-template-id=\'' + soy.$$escapeHtml(opt_data.templateId) + '\'' : '', (opt_data.blueprintModuleCompleteKey) ? 'data-blueprint-module-complete-key=\'' + soy.$$escapeHtml(opt_data.blueprintModuleCompleteKey) + '\'' : '', 'href=\'#\'>', soy.$$escapeHtml(opt_data.buttonLabel), '</button>');
  return opt_sb ? '' : output.toString();
};
        ...
        AJS.I18n.get("com.atlassian.confluence.plugins.confluence-like", function () {
            ...
            function updateLikeSummary(data, contentId, $summaryContainer) {
                ...
                $summaryContainer.find(".likes").click(function () {
                    ...
                    likesDialog.addHeader("\u8D5E\u540C\u8005");
                    likesDialog.addPanel("Panel 1", "<div class='spinner-container'></div>");
                    likesDialog.addCancel("\u5173\u95ED", function (dialog) {
                        dialog.remove();
                        likesDialog = undefined;
                    });
...
Confluence.Templates.Likes.likeSection = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div id="likes-section">', (opt_data.showLikeButton) ? '<a href="" class="like-button">' + soy.$$escapeHtml("\u8d5e\u540c") + '</a>' : '', '<span class="like-summary"></span></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Likes.commentLikeSection = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<li class="comment-action-like">', (opt_data.showLikeButton) ? '<a href="" class="like-button">' + soy.$$escapeHtml("\u8d5e\u540c") + '</a>' : '', '<span class="like-summary"></span></li>');
  return opt_sb ? '' : output.toString();
};
...
AJS.Confluence.QuickEdit = {
    ...
    activateEditor: function($container, saveHandler, cancelHandler, transition, fallbackUrl) {
        ...
        var errorTimeoutId = setTimeout(function() {
            ...
            unblocker();
            displayError("\u52A0\u8F7D\u7F16\u8F91\u5668\u8D44\u6E90\u8D85\u65F6\u3002", fallbackUrl);
