...
Confluence.Templates.PagePermissions.inheritedPermissionsTable = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="page-inherited-permissions-owner-div"><div class="page-inherited-permissions-table-desc">', "\u67e5\u770b\u5bf9\u201c\x3ca\x3e\x3c/a\x3e\u201d\u7684\u9650\u5236\uff0c\u5982\u679c\u8981\u67e5\u770b \u201c\x3cspan\x3e\x3c/span\x3e\u201d, \u7528\u6237\u5fc5\u987b\u662f\u4ee5\u4e0b\u7528\u6237\u4e4b\u4e00\u6216\u5728\u4ee5\u4e0b\u7528\u6237\u7ec4\u5185\u3002", '</div><table class="page-permissions-table"></table></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.ManageWatchers.dialogContent = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="dialog-content"><div class="column page-watchers"><h3>', soy.$$escapeHtml("\u5173\u6ce8\u672c\u9875\u9762"), '</h3><p class="description">', soy.$$escapeHtml("\u8fd9\u4e9b\u7528\u6237\u5f53\u9875\u9762\u53d8\u66f4\u4f1a\u83b7\u5f97\u901a\u77e5\u3002 \u53ef\u4ee5\u5bf9\u5217\u8868\u4e2d\u7684\u7528\u6237\u8fdb\u884c\u6dfb\u52a0\u548c\u5220\u9664\u3002"), '</p><form action="', soy.$$escapeHtml(""), '/json/addwatch.action" method="POST"><input type="hidden" name="atl_token" value="', soy.$$escapeHtml(opt_data.xsrfToken), '"><input type="hidden" name="pageId" value="', soy.$$escapeHtml(opt_data.pageId), '"/><input type="hidden" id="add-watcher-username" name="username" value=""/><label for="add-watcher-user">', soy.$$escapeHtml("\u7528\u6237"), '</label><input id="add-watcher-user" name="userFullName" type="search" class="autocomplete-user" value="" placeholder="', soy.$$escapeHtml("\u5168\u540d\u6216\u767b\u5f55\u540d"), '" autocomplete="off" data-max="10" data-target="#add-watcher-username" data-dropdown-target="#add-watcher-dropdown" data-template="{title}" data-none-message="', soy.$$escapeHtml("\u65e0\u5339\u914d\u7528\u6237\u3002"), '"><input id="add-watcher-submit" type="submit" name="add" value="', soy.$$escapeHtml("\u6dfb\u52a0"), '"><div id="add-watcher-dropdown" class="aui-dd-parent autocomplete"></div><div class="status hidden"></div></form><ul class="user-list"><li class="loading">', "\u6b63\u88c5\u8f7d\u2026", '</li><li class="no-users hidden">', soy.$$escapeHtml("\u65e0\u9875\u9762\u5173\u6ce8\u4eba"), '</li></ul></div><div class="column space-watchers"><h3>', soy.$$escapeHtml("\u5173\u6ce8\u672c\u9875\u9762"), '</h3><p class="description">', soy.$$escapeHtml("\x3d\u8fd9\u4e9b\u7528\u6237\u5f53\u7a7a\u95f4\u5185\u5bb9\u53d8\u66f4\u4f1a\u83b7\u5f97\u901a\u77e5\u3002 \u53ef\u4ee5\u6539\u53d8\u5217\u8868\u8bbe\u7f6e\u3002"), '</p><ul class="user-list"><li class="loading">', "\u6b63\u88c5\u8f7d\u2026", '</li><li class="no-users hidden">', soy.$$escapeHtml("\u65e0\u7a7a\u95f4\u5173\u6ce8\u4eba"), '</li></ul></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.breadcrumbLoading = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<li class="loading"><span>', "\u6b63\u88c5\u8f7d\u5bfc\u822a\u680f\u2026", '</span></li>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.MovePage.panelLoading = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<span>', soy.$$escapeHtml("\u6b63\u88c5\u8f7d\u2026"), '</span>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.CreateSpace.createSpaceForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<p>', soy.$$escapeHtml("\u4e3a\u60a8\u7684\u56e2\u961f\u6216\u9879\u76ee\u521b\u5efa\u4e00\u4e2a\u7a7a\u95f4:"), '</p><form action="', soy.$$escapeHtml(""), '/spaces/createspace.action" method="post" class="aui" id="create-space-form"><fieldset><div class="field-group"><label for="name">', soy.$$escapeHtml("\u7a7a\u95f4\u540d\u79f0"), '</label><input class="text" name="name" autocomplete="off" ', (opt_data.name) ? 'value="' + soy.$$escapeHtml(opt_data.name) + '"' : '', '/>');
  ...
  output.append('</div><div class="field-group"><label for="key">', soy.$$escapeHtml("\u7a7a\u95f4\u5173\u952e\u5b57"), '</label><input class="text" name="key" ', (opt_data.key) ? 'value="' + soy.$$escapeHtml(opt_data.key) + '"' : '', '/><div class="description">', AJS.format("\u5728\u7a7a\u95f4URL\u4e2d\u4f7f\u7528: {0}",'<br /><span id="space-url-example"></span>'), '</div>');
...
Confluence.Templates.CreateSpace.createPersonalSpaceForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form action="', soy.$$escapeHtml(""), '/spaces/docreatepersonalspace.action" method="post" class="aui" id="create-personal-space-form"><p>', "\u60a8\u7684\u4e2a\u4eba\u7a7a\u95f4\u662f\u60a8\u4e2a\u4eba\u7684Confluence\u79c1\u6709\u7a7a\u95f4\uff0c\u60a8\u80fd\u591f\u9009\u62e9\u8ba9\u5176\u4ed6\u4eba\u67e5\u770b\u6216\u521b\u5efa\u5185\u5bb9\u3002", '</p>');
  Confluence.Templates.CreateSpace.spaceFormPermissions(opt_data, output);
  output.append('<input type="hidden" name="atl_token" value="', soy.$$escapeHtml(opt_data.atlToken), '" />');
  if (opt_data.buttons) {
    Confluence.Templates.CreateSpace.spaceFormButtons(null, output);
...
Confluence.Templates.CreateSpace.spaceFormPermissions = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<fieldset class="group', (opt_data.spacePermission == 'private') ? ' locked' : '', '" id="permissions-group"><div class="checkbox"><input class="checkbox" type="checkbox" id="permission-private" name="spacePermission" value="private"', (opt_data.spacePermission == 'private') ? ' checked="checked"' : '', ' /><label for="permission-private">', soy.$$escapeHtml("\u8ba9\u6b64\u7a7a\u95f4\u4f5c\u4e3a\u79c1\u6709\u7a7a\u95f4"), '</label></div></fieldset>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.CreateSpace.spaceFormButtons = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="buttons-container"><div class="buttons"><input name="create" class="aui-button aui-button-primary" type="submit" value="', soy.$$escapeHtml("\u521b\u5efa"), '" /><a href="', soy.$$escapeHtml(""), '/dashboard.action" class="aui-button aui-button-link">', soy.$$escapeHtml("\u53d6\u6d88"), '</a></div></div>');
  return opt_sb ? '' : output.toString();
};
...
try {
AJS.toInit(function(e){var l=null,q,d,o,r,n,j=false,p,c=100;var i={key:function(){var t=e.Deferred();var u=e.trim(q.val());if(!u){t.reject("\u60A8\u5FC5\u987B\u8F93\u5165\u7A7A\u95F4\u5173\u952E\u5B57\u3002");return t}if(p){AJS.log("Aborting previous space key validation request.");p.abort()}p=e.getJSON(AJS.Confluence.getContextPath()+"/ajax/spaceavailable.action",{key:u}).done(function(v){if(!v.available&&v.message){t.reject(v.message)}else{t.resolve()}p=false});return t.promise()},name:function(){var t=e.Deferred();if(!e.trim(d.val())){t.reject("\u60A8\u5FC5\u987B\u8F93\u5165\u7A7A\u95F4\u540D\u79F0\u3002")}else{t.resolve()}return t.promise()}};function m(w){var v=w[0];if(v.setSelectionRange){var u=w.val().length;v.setSelectionRange(0,u)}else{if(v.createTextRange){var t=v.createTextRange();t.execCommand("SelectAll");t.select()}}}function h(t){if(t){o.removeAttr("disabled")}else{o.attr("disabled","disabled")}j=t}var s={};function b(v){h(false);var t=v.attr("name");var u=v.siblings(".error");s[t]=true;var w=i[t]();w.done(function(){delete s[t];u.text("").addClass("hidden")});w.fail(function(x){u.text(x).removeClass("hidden")});w.always(function(){h(e.isEmptyObject(s));v.attr("data-validated-value",v.val())});return w}function a(t){var x=t.find("#space-url-example"),u=AJS.Meta.get("base-url")+"/display/",v="<"+"\u7A7A\u95F4\u5173\u952E\u5B57"+">",z=function(B){B=B||v;var A=u+B;x.text(A)},w=false;h(false);z();q=t.find("input[name='key']").first();d=t.find("input[name='name']").first();r=q.parent().find(".error");n=d.parent().find(".error");q.generateFrom(d,{uppercase:false,maxNameLength:255,maxKeyLength:255,timeoutMS:c,validationCallback:function(){q.keyup()}});function y(){var B=e(this);var A=B.val();if(typeof B.data("originalVal")==="undefined"){B.data("originalVal","")}if(B.data("originalVal")===A){return}B.data("originalVal",A);b(B)}q.keyup(e.debounce(y,500));d.keyup(y);q.keyup(function(){z(q.val())});q.focus(function(){m(q)});t.find("#permission-private").change(function(){e("#permissions-group").toggleClass("locked")});t.submit(function(A){if(!w){A.preventDefault()}else{return}setTimeout(function(){var C=b(q);var B=b(d);e.when({},C,B).then(function(){if(j){w=true;t.submit()}})},c+1)})}function f(){var u=e(Confluence.Templates.CreateSpace.createSpaceForm({atlToken:e("#atlassian-token").prop("content")})),t=function(){u.submit()},v=function(){w.hide();d.val("");q.val("");r.text("").addClass("hidden");n.text("").addClass("hidden");h(false)},w=new AJS.ConfluenceDialog({width:600,height:400,id:"create-space-dialog",closeOnOutsideClick:true,onCancel:v,onSubmit:t});w.addHeader("\u521B\u5EFA\u7A7A\u95F4");w.addPanel("Panel 1",u);w.addSubmit("\u521B\u5EFA",t);w.addCancel("\u53D6\u6D88",v);w.popup.element.find(".dialog-title").prepend(Confluence.Templates.CreateSpace.helpLink());o=w.popup.element.find(".button-panel-submit-button");a(u);w.gotoPage(0);w.gotoPanel(0);return w}function g(t){t&&t.preventDefault();if(!l){l=f()}l.show()}AJS.bind("ready-for-create-space-form-init",function(u,t){o=t.find("input[type=submit]");a(t)});e('a[href="'+AJS.contextPath()+'/spaces/createspace-start.action"]').click(g);var k=e("#create-space-form:not(.noautobind)");if(k.length){AJS.trigger("ready-for-create-space-form-init",[k])}});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
try {
AJS.toInit(function(d){var c=null,b=function(){var f=d(Confluence.Templates.CreateSpace.createPersonalSpaceForm({atlToken:d("#atlassian-token").prop("content")})),e=function(){f.submit()},g=new AJS.ConfluenceDialog({width:540,height:300,id:"create-personal-space-dialog",closeOnOutsideClick:true,onSubmit:e});g.addHeader("\u6DFB\u52A0\u4F60\u7684\u4E2A\u4EBA\u7A7A\u95F4");g.addPanel("Panel 1",f);g.addSubmit("\u521B\u5EFA",e);g.addCancel("\u53D6\u6D88",function(){g.hide()});g.gotoPage(0);g.gotoPanel(0);return g},a=function(){if(c==null){c=b()}c.show();d("#create-personal-space-dialog button.button-panel-submit-button").focus()};d("#create-personal-space-link").click(function(){a();return false})});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
try {
Confluence.Blueprint.Dialog={};AJS.toInit(function(f){var w=f("#create-page-button");if(!w.length){return}w.click(function(){Confluence.Blueprint.Dialog.openDialog();return false});f(document).on("click",".create-child-page-link",function(){Confluence.Blueprint.Dialog.openDialog({location:"child-page"});return false});f("#addPageLink, #addBlogLink, .acs-pagetree-create-link").hide();var B,s;var o="com.atlassian.confluence.plugins.confluence-create-content-plugin:create-blog-post";var m;var b=null;var h=f.getJSON(Confluence.getContextPath()+"/rest/create-dialog/1.0/spaces",{promotedSpaceKey:AJS.params.spaceKey,promotedSpacesLimit:10,otherSpacesLimit:1000}).done(function(J){Confluence.Blueprint.Dialog.loadedSpaces=J;var I=J.promotedSpaces.spaces[0]||J.otherSpaces.spaces[0];B=Confluence.Blueprint.Dialog.requestWebItems(I.id).done(function(){AJS.trigger("create-dialog.data-ready")});s=g(I.id)});Confluence.Blueprint.Dialog.requestWebItems=function n(I){Confluence.Blueprint.Dialog.loadedWebitems=Confluence.Blueprint.Dialog.loadedWebitems||{};var J=Confluence.Blueprint.Dialog.loadedWebitems[I];if(J){return AJS.$.Deferred().resolveWith(J)}return f.ajax({url:Confluence.getContextPath()+"/rest/create-dialog/1.0/blueprints/web-items",dataType:"json",data:{spaceKey:I}}).done(function(K){Confluence.Blueprint.Dialog.loadedWebitems[I]=K})};function g(I){return f.ajax({url:Confluence.getContextPath()+"/rest/create-dialog/1.0/spaces/adminCheck",dataType:"json",data:{spaceKey:I}})}function v(K,J){var I=K;J.find(".add-remove-customise-templates-trigger").toggle(I)}function p(I,J){var K=J.find(".template-select-container");K.addClass("loading");Confluence.Blueprint.Dialog.requestWebItems(I).done(function(L){r(J);K.removeClass("loading")}).fail(function(){Confluence.sessionFail&&Confluence.sessionFail()})}function i(L,I){var J=AJS.Meta.get("space-key");if(!J||(J!=m.val())){return false}if(!AJS.Meta.get("page-title")){return false}if(!I){return true}var K=I.data();var M=K.itemModuleCompleteKey;return(M!=o)}function H(){return b}function c(K,J){var I=K.find("#create-dialog-parent-container");if(i(K,J)){I.find("span").text(AJS.Meta.get("page-title"));I.show();b=AJS.Meta.get("page-id")}else{I.hide();b=null}}function k(I,N){var K=I.find(".template");var M=K.filter(".selected");var J=K.index(M)+N;J=J%K.length;var L=K.eq(J);e(L);L.focus();I.simpleScrollTo(L)}function y(J){var I=2;switch(J){case 37:return -1;case 39:return +1;case 38:return -I;case 40:return +I}return 0}function t(I){I.bind("keydown",function(J){var K=y(J.which);if(K){k(I,K);return AJS.stopEvent(J)}})}function A(I){return I?"Create":"Next"}function D(J){var I=!!d(J).wizard;var K=A(!I);G().text(K)}function G(){return f(".create-dialog-create-button:visible")}function e(I){I.addClass("selected").siblings().removeClass("selected");D(C(I));c(F,I)}function j(){var I=m.val();return I||AJS.Meta.get("space-key")}function r(J){var K=Confluence.Blueprint.Dialog.loadedWebitems[j()];if(J.options.location=="child-page"){K=_.reject(K,function(L){return L.itemModuleCompleteKey==o})}var I=Confluence.Templates.Blueprints.templates({webItems:K});if(J.find(".templates").length){J.find(".templates").replaceWith(I)}else{f(".template-select-container-body").append(I)}f(".template").click(function(){e(f(this))}).dblclick(function(){G().click()}).focus(function(){f(this).click()});t(J.find(".templates"));if(J.searcher){J.searcher.refreshItems();J.searcher.filter()}f(".template:first-child").click()}function E(K){var J=[];var L=K.promotedSpaces.spaces;if(L&&L.length){J.push({text:"Suggested Spaces",children:L})}var I=K.otherSpaces&&!K.otherSpaces.resultsTruncated&&K.otherSpaces.spaces;if(I&&I.length){J.push({text:"\u5168\u90E8\u7A7A\u95F4",children:I})}return J}function u(P,O){if(P.otherSpaces&&P.otherSpaces.resultsTruncated){var K=O.find(".space-select-control-container .description");K.removeClass("hidden");var L={gravity:"w",delayIn:500,delayOut:0,offset:5};K.find("a").tooltip(L).click(function(){return false})}m.auiSelect2({data:E(P),escapeMarkup:function(Q){return Q},width:"270px",containerCssClass:"select2-space-select",formatResult:function(Q,R,S){R.attr("title",f("<div/>").html(Q.text).text());return f.fn.select2.defaults.formatResult.apply(this,arguments)},openOnEnter:false});var J=m.data("select2");J.data(P.promotedSpaces.spaces[0]||P.otherSpaces.spaces[0]);var M=50;var I=J.opts.populateResults;J.opts.populateResults=function(Q,R,S){var U=false;var T=R;if(R[1]&&R[1].children&&R[1].children.length>M){T=[];f(R).each2(function(){T.push(f.extend(true,{},this))});T[1].children=T[1].children.slice(0,M);T[1].children.push({text:"Type to find more spaces"});U=true}I.call(J,Q,T,S);U&&R[1].children.pop()};var N=O.find(".select2-space-select .select2-input");if(N.length&&"placeholder" in N[0]){N.attr("placeholder","Filter spaces"+" ...")}f(Confluence.Templates.Blueprints.customiseTemplatesLink()).prependTo(O.find(".dialog-button-panel")).click(function(){window.location=Confluence.getContextPath()+"/pages/templates2/listpagetemplates.action?key="+m.val();return false})}function a(K){var L=C(K),J=K.data("template-id"),M=L||J,I=L?"itemModuleCompleteKey":"templateId";return x(I,M)}function d(I){return x("itemModuleCompleteKey",I)}function x(I,J){return _.find(Confluence.Blueprint.Dialog.loadedWebitems[j()],function(K){return K[I]==J})}function C(I){return I.data("item-module-complete-key")}function q(I){if(f(this).attr("disabled")==="disabled"){return false}f(this).attr("disabled","disabled").before('<img class="wait-icon" src="'+Confluence.getContextPath()+'/images/icons/wait.gif">');var L=m.val();var K=f(".template.selected");var J=a(K);if(!J){throw new Error("Expected at least one template to be selected")}J.name=K.find(".template-name").text();J.spaceKey=L;Confluence.Blueprint.fireWizard(I,J,l)}var l,F;function z(){AJS.trigger("analytics",{name:"create-dialog.cancel"});l.remove();f(".tipsy").remove();l=null;F=null;return false}Confluence.Blueprint.Dialog.addBackButton=function(I,J){I.addButton("Back",function(K){J&&J();K.prevPage();I.remove();K.page.pop()},"button-panel-back")};Confluence.Blueprint.Dialog.addButtonPanel=function(M,L,I,K){var J=A(I);M.addButton(AJS.I18n.getText(J),null,"create-dialog-create-button");M.buttonpanel.find(".create-dialog-create-button").removeClass("button-panel-button").addClass("aui-button aui-button-primary").click(L);if(K){M.buttonpanel.addClass(K)}l.addCancel("\u5173\u95ED",z)};Confluence.Blueprint.Dialog.addFullButtonPanel=function(K,J,L,I){this.addBackButton(K,L);this.addButtonPanel(K,J,I);return K.buttonpanel};Confluence.Blueprint.Dialog.openDialog=function(K){function J(){Confluence.Blueprint.Dialog.HowToUse.notifyCancel(l);AJS.trigger("analytics",{name:I+".cancel"});l.remove();f(".tipsy").remove();l=null;F=null;return false}var I="create-dialog",M=function(O){if(l){if(O.keyCode===27){J()}else{if(O.keyCode===13){var P=O.target.nodeName&&O.target.nodeName.toLowerCase();if(P=="textarea"){return}G().click()}}}};var L={width:840,id:I,closeOnOutsideClick:false,keypressListener:M,focusSelector:".templates"};l=new AJS.Dialog(L);F=l.popup.element;l.addHeader("Create");var N=F.searcher=Confluence.DomFilterField({items:"#create-dialog .templates .template",postSearch:function(O){O.eq(0).click()},submitCallback:function(O,P){O.eq(0).dblclick()}});N.form.find("input").attr("tabindex",100);F.find(".dialog-title").prepend(Confluence.Templates.Blueprints.helpLink(),N.form);l.addPanel("SinglePanel",Confluence.Templates.Blueprints.createDialogBody({contextPath:Confluence.getContextPath()}),"loading");Confluence.Blueprint.Dialog.addButtonPanel(l.getPage(0),q);l.prevPage=function(){F.find(".wait-icon").remove();F.find(".create-dialog-create-button").removeAttr("disabled");return AJS.Dialog.prototype.prevPage.apply(l,arguments)};l.getParentPageId=H;F.find(".dialog-button-panel").find("button, .button-panel-link").attr("tabindex",100);m=F.find(".create-dialog-location-bar .space-select");F.options=K=f.extend({showDialog:true,updateHeight:true},K);c(F);l.getPanel(0).setPadding(0);l.gotoPanel(0);K.showDialog&&l.show();h.done(function(){u(Confluence.Blueprint.Dialog.loadedSpaces,F);B.done(function(Q){r(F);f("#create-dialog .dialog-panel-body.loading").removeClass("loading");K.updateHeight&&l.updateHeight();try{var O=f._data(document).events.keydown;var T=O.length;if(T<2){return}var P=O[T-1].handler;var S=O[T-2].handler;if((P===S)&&(S===M)){O.pop();AJS.log("Create Dialog - Removed duplicated keydown listener")}else{AJS.log("Create Dialog - AUI-1322 is fixed, remove this code!")}}catch(R){AJS.log("Error attempting to removed doubled keypressListener from jQuery")}});s.done(function(O){v(O,F)})});F.find(".create-dialog-location-bar input").change(function(){var O=f(this).val();p(O,F);g(O).done(function(P){v(P,F)})});Confluence.sessionCheck&&Confluence.sessionCheck();return l}});AJS.bind("shortcuts-loaded.keyboardshortcuts",function(b,a){AJS.$.each(a.shortcuts,function(d,c){if(c.param=="#createPageLink"){a.shortcuts.splice(d,1);return false}})});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
