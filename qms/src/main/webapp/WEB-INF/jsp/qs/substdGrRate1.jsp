...
<html>
<head>
<title>团期丰富度不合格问题发生率-组织架构维度</title>
...
function search() {
	$("#grForm").attr("action", "qs/substdProductSnapshot/showSubstdGrRate1");
	$("#grForm").submit();
}
</script>
</head>
<body>
<form id="grForm" method="post" action="qs/substdProductSnapshot/showSubstdGrRate1">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>团期丰富度不合格问题发生率-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
