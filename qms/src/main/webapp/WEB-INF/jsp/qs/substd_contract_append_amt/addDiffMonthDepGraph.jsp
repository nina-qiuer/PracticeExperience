...
<html>
<head>
<title>跨月添加合同增补单图表-组织架构维度</title>
...
require(
    ...
    function (ec) {
		...
		var dataChartNum = ec.init(document.getElementById('mainNum')); // 添加合同增补单数
        var dataChartTotPrice = ec.init(document.getElementById('mainTotPrice')); // 添加合同增补总额
...
function search() {
	$("#dataForm").attr("action", "qs/substdContractAppendAmt/addDiffMonthDepGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdContractAppendAmt/addDiffMonthDepGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>跨月添加合同增补单图表-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
