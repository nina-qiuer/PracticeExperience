...
<html>
<head>
<title>牛人专线组团形式问题发生率-组织架构维度</title>
...
function search() {
	$("#grForm").attr("action", "qs/substdProductSnapshot/showUnAloneGroupRate1");
	$("#grForm").submit();
}
</script>
</head>
<body>
<form id="grForm" method="post" action="qs/substdProductSnapshot/showUnAloneGroupRate1">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>牛人专线组团形式问题发生率-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
