...
function search() {
	$("#ntoForm").attr("action", "qs/substdOrderSnapshot/showNoticeTimeoutRate1");
	$("#ntoForm").submit();
}
</script>
</head>
<body>
<form id="ntoForm" method="post" action="qs/substdOrderSnapshot/showNoticeTimeoutRate1">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>出团通知超时率-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
