...
function search() {
	...
	$("#dataForm").attr("action", "qs/compSatisRate/prdTeamList/"+targetId);
	$("#dataForm").submit();
}

function addSatisfyTabx(prdTeam,targetId) {
    ...
    if(targetId ==0 ){
		...
		parent.addSatisfyTab(prdTeam,targetId,"prdManagerList",timeType,nextSearch);
	 }
}
...
<tr>
	...
	<tr>
		...
		<td >
		  <a href="javascript:void(0)" onclick="addSatisfyTabx('${satisfy.prdTeam}','${satisfy.targetId}')">详情</a>
		</td>
		<td>
