...
require(
    ...
    function (ec) {
        ...
        dataChartNum.setOption(optionNum); // 跨月采购单数
        
        var dataChartTotPrice = ec.init(document.getElementById('mainTotPrice'));
        dataChartTotPrice.setOption(optionTotPrice); // 跨月采购总额
    }
);
...
function search() {
	$("#dataForm").attr("action", "qs/substdPurchaseAmt/addDiffMonthDateGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdPurchaseAmt/addDiffMonthDateGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>跨月添加采购单图表-添加日期维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
