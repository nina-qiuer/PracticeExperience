...
function search() {
	$("#addDiffMonthForm").attr("action", "qs/substdPurchaseAmt/addDiffMonthList");
...
<body>
<form id="addDiffMonthForm" method="post" action="qs/substdPurchaseAmt/addDiffMonthList">
...
<table class="listtable">
	...
	<tr>
		...
		<td>${purchase.type}</td>
		<td>${purchase.signDate}</td>
		<td>${purchase.backDate}</td>
		<td>${purchase.addDate}</td>
		<td>${purchase.price}</td>
		<td>${purchase.addPerson}</td>
		<td>${purchase.monthTotalAmount}</td>
		<td class="orderId">${purchase.ordId}</td>
