...
function search() {
	$("#negativePurchaseForm").attr("action", "qs/substdPurchaseAmt/negativePurchaseList");
	$("#negativePurchaseForm").submit();
}

function resetForm() {
	$("input[type=text]", "#negativePurchaseForm").val('');
	$("#pageNo").val('1');
}
</script>
</head>
<body>
<form id="negativePurchaseForm" method="post" action="qs/substdPurchaseAmt/negativePurchaseList">
