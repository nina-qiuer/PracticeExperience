...
require(
    ...
    function (ec) {
		...
		var dataChartNum = ec.init(document.getElementById('mainNum')); // 超时采购单数
        var dataChartTotPrice = ec.init(document.getElementById('mainTotPrice')); // 超时采购总额
...
function search() {
	$("#dataForm").attr("action", "qs/substdPurchaseAmt/addTimeoutDepGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdPurchaseAmt/addTimeoutDepGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>采购单添加超时图表-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
