...
require(
    ...
    function (ec) {
        ...
        dataChartNum.setOption(optionNum); // 导致订单负利润-采购单数
        
        var dataChartTotPrice = ec.init(document.getElementById('mainTotPrice'));
        dataChartTotPrice.setOption(optionTotPrice); // 导致订单负利润-采购总额
    }
);
...
function search() {
	$("#dataForm").attr("action", "qs/substdPurchaseAmt/negativeProfitDateGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdPurchaseAmt/negativeProfitDateGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>订单负利润图表-添加日期维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
