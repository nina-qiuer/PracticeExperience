...
require(
    ...
    function (ec) {
		...
		var dataChartNum = ec.init(document.getElementById('mainNum')); // 非现付且金额小于0采购单数
        var dataChartTotPrice = ec.init(document.getElementById('mainTotPrice')); // 非现付且金额小于0采购总额
...
function search() {
	$("#dataForm").attr("action", "qs/substdPurchaseAmt/substdNonpayDepGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdPurchaseAmt/substdNonpayDepGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>非现付采购单图表-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
