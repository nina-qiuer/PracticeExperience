...
function search() {
	$("#negativeProfitForm").attr("action", "qs/substdPurchaseAmt/negativeProfitList");
	$("#negativeProfitForm").submit();
}

function resetForm() {
	$("input[type=text]", "#negativeProfitForm").val('');
	$("#pageNo").val('1');
}
</script>
</head>
<body>
<form id="negativeProfitForm" method="post" action="qs/substdPurchaseAmt/negativeProfitList">
