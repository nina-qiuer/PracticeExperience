...
function search() {
	$("#addTimeoutForm").attr("action", "qs/substdPurchaseAmt/addTimeoutList");
	$("#addTimeoutForm").submit();
}

function resetForm() {
	$("input[type=text]", "#addTimeoutForm").val('');
	$("#pageNo").val('1');
}
</script>
</head>
<body>
<form id="addTimeoutForm" method="post" action="qs/substdPurchaseAmt/addTimeoutList">
