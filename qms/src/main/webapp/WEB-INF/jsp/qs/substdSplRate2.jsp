...
<html>
<head>
<title>销售期长不合格问题发生率-统计日期维度</title>
...
function search() {
	$("#splForm").attr("action", "qs/substdProductSnapshot/showSubstdSplRate2");
	$("#splForm").submit();
}
</script>
</head>
<body>
<form id="splForm" method="post" action="qs/substdProductSnapshot/showSubstdSplRate2">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>销售期长不合格问题发生率-统计日期维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
