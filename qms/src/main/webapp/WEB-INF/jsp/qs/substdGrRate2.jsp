...
<html>
<head>
<title>团期丰富度不合格问题发生率-统计日期维度</title>
...
require(
    ...
    function (ec) {
		...
		<c:forEach items="${dataList}" var="map">
			...
			substdNums.push('${map.substdGrPrdNumTotal}');
...
function search() {
	$("#grForm").attr("action", "qs/substdProductSnapshot/showSubstdGrRate2");
	$("#grForm").submit();
}
</script>
</head>
<body>
<form id="grForm" method="post" action="qs/substdProductSnapshot/showSubstdGrRate2">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>团期丰富度不合格问题发生率-统计日期维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
