...
require(
    ...
    function (ec) {
        ...
        dataChartNum.setOption(optionNum); // 合同价异常单数
        
        var dataChartTotAmount = ec.init(document.getElementById('mainTotAmount'));
        dataChartTotAmount.setOption(optionTotAmount); // 合同价异常总额
    }
);
...
function search() {
	$("#dataForm").attr("action", "qs/substdOrderAmt/contractAmountAbnormalDateGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdOrderAmt/contractAmountAbnormalDateGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>合同价异常图表-签约日期维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
