...
require(
    ...
    function (ec) {
		...
		var dataChartNum = ec.init(document.getElementById('mainNum')); // 超时收款单数
        var dataChartTotAmount = ec.init(document.getElementById('mainTotAmount')); // 超时未收总额
...
function search() {
	$("#dataForm").attr("action", "qs/substdOrderAmt/collectTimeoutDepGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdOrderAmt/collectTimeoutDepGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>订单收款超时图表-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
