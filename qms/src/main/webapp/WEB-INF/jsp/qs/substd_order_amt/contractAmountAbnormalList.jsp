...
function search() {
	$("#contractAmountAbnormalForm").attr("action", "qs/substdOrderAmt/contractAmountAbnormalList");
	$("#contractAmountAbnormalForm").submit();
}

function resetForm() {
	$("input[type=text]", "#contractAmountAbnormalForm").val('');
	$("#pageNo").val('1');
}
</script>
</head>
<body>
<form id="contractAmountAbnormalForm" method="post" action="qs/substdOrderAmt/contractAmountAbnormalList">
...
<table width="95%">
	...
	<tr>
		...
		<td>
			签约日期：<form:input path="dto.statisticDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" size="10"/>
		</td>
