...
require(
    ...
    function (ec) {
		...
		var dataChartNum = ec.init(document.getElementById('mainNum')); // 导致超额退款-退款单数
        var dataChartTotAmount = ec.init(document.getElementById('mainTotAmount')); // 导致超额退款-退款总额
...
function search() {
	$("#dataForm").attr("action", "qs/substdRefundAmt/beyondRefundDepGraph");
	$("#dataForm").submit();
}
</script>
</head>
<body>
<form id="dataForm" method="post" action="qs/substdRefundAmt/beyondRefundDepGraph">
<input type="hidden" name="tokenKey" value="${tokenKey}">
<input type="hidden" name="tokenValue" value="${tokenValue}">
<div id="accordion">
<h3>订单超额退款图表-组织架构维度</h3>
<div align="right">
<table width="70%">
	<tr>
		<td>
