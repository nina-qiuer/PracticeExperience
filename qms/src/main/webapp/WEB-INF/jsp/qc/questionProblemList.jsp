...
<div class="pici_search pd5" align="right">
	<input type="button" value="添加质量问题单" title="添加质量问题单" class="blue" style="cursor: pointer;"
		onclick="openWinow('添加质量问题单', 'qc/qualityProblem/${userFlag}/${qcBillId}/addQuestion', 870, 450,'20%','30%')">
</div>
...
<table class="datatable">
	<tr>
		...
		<th width="100">问题类型：</th><td>
			${qp.qptName}
			<c:if test="${qp.lowSatisDegree == 1}"> <span style="color: green;">【低满意度（满意度小于等于50%）】</span></c:if>
		</td>
		<th width="80" rowspan="3">操作：</th>
		<td width="150" align="center" rowspan="3">
			<input type="button" class="blue" style="width:100px" value="修改" onclick="openWinow('修改质量问题单', 'qc/qualityProblem/${userFlag}/${qp.id}/updateQuestion', 870, 450,'20%','30%')"><br>
	...
	<tr>
		<td colspan="6">
			<div class="accordion">
				<h3>责任单</h3>
				<div>
				 <iframe src="qc/qualityProblem/${qp.id}/${qp.qcId}/resp" width="100%" height="300px" id="respBill" name="respBill" scrolling="auto" frameborder="0"></iframe>
				</div>
			</div>
		</td>
	</tr>
