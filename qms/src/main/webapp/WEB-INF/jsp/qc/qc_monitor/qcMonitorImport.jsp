...
function  startUpload() {
	...
	$.ajaxFileUpload({
		url : 'qc/upload/qcMonitorUpload', //需要链接到服务器地址  
		secureuri : false,
		...
		success: function (result)            //相当于java中try语句块的用法  
          {       
            	if(result.retCode == "0")
				{
		    		...
		    		alert(result.resMsg);
		    		parent.search();
		    		// window.setTimeout(parent.layer.alert(result.resMsg), 3000);
		    		// parent.layer.alert(result.resMsg); 
...
<form id="score_form" name="score_form" action="" method="post" enctype="multipart/form-data">
	...
	<tr>
		...
		<td align="left">
			<a href="res/template/cmp_qc_monitor_template.xlsx">cmp_qc_monitor_template.xlsx</a>
		</td>
	</tr>
		<tr>
			<td>
