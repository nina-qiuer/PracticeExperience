...
<script type="text/javascript">
	...
	function search() {
		$("#searchForm").attr("action", "qc/qcBill/qcList");
		$("#searchForm").submit();
	}
...
<body>
<form name="form" id="searchForm" method="post" action="qc/qcBill/qcList">
...
<table class="listtable">
	...
	<tr>
		...
		<td class="id">	
			<a href="javascript:void(0)" onclick="openWin('质检报告','qc/qcBill/${qcBill.id}/qcReport',1000,520)">${qcBill.id}</a>
		</td>
