...
function  startUpload() {
	...
	$.ajaxFileUpload({
		url : 'qc/upload/devFileUpload', //需要链接到服务器地址  
		secureuri : false,
...
<form id="qualityForm" name="qualityForm" action="" method="post" enctype="multipart/form-data">
	<input type="hidden" name="devId" id="devId" value="${devId}"/><br>
