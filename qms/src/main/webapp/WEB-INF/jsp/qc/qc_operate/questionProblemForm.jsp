...
<form:hidden path="qualityProblem.impAdvice"/>
...
<td>
	...
	<a id="menuBtn" href="javascript:void(0)" onclick="openTopWinow('问题类型', 'qc/qualityProblem/getQpType?qcFlag=${qcFlag}',  600,300)">选择</a>
</td>
</tr>
<tr>
		<th align="right" width="100" height="30">异常原因：
			<input type="button" class="blue"  value="选择话术"
			 onclick="openWin('选择运营质检模板', 'common/talkConfig/toChoose', 700, 300)">
		</th>
		<td colspan="3">
			<textarea id="description" name="description" style="width:700px;height:250px;visibility:hidden;">${qualityProblem.description}</textarea>
		</td>
	</tr>
	<tr>
