...
<div class="pici_search pd5" align="right">
	<input type="button" value="添加质量问题单" title="添加质量问题单" class="blue" style="cursor: pointer;"
		onclick="parent.openWinow('添加质量问题单', 'qc/qualityProblem/${qcBillId}/addOperQuestion', 870, 400,'20%','30%')">
</div>
...
<table class="datatable">
	<tr>
		...
		<td width="150" align="center" rowspan="3">
			<input type="button" class="blue" style="width:100px" value="修改" onclick="parent.openWinow('修改质量问题单', 'qc/qualityProblem/${qp.id}/updateOperQuestion', 870, 400,'20%','30%')"><br>
	...
	<tr>
		...
		<td colspan="1">${qp.qptName}</td>
	</tr>
	<tr>
		<th>异常原因：</th>
		<td colspan="1">${qp.description}</td>
	</tr>
	...
	<tr>
		<td colspan="6">
			<div class="accordion">
				<h3>责任单</h3>
				<div>
				 <iframe src="qc/qualityProblem/${qp.id}/${qp.qcId}/operResp" width="100%" height="250px" id="respBill" name="respBill" scrolling="auto" frameborder="0"></iframe>
				</div>
			</div>
		</td>
	</tr>
