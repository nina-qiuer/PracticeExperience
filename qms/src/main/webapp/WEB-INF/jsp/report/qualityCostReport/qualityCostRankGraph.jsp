...
require(
    ...
    function (ec) {
        	...
        	<c:forEach items="${respList}" var="map">
	        	var rank = parseInt('${map.rank}');
				if(rank ==0){
...
function search() {
	...
	$("#dataForm").attr("action", "report/qualityCostReport/qualityCostRank");
	$("#dataForm").submit();
}
</script>
</head>
...
<table width="100%">
<tr style="margin:0; padinng:0;">
		<td width="33%" style="vertical-align:top;"><div id="mainNumOne" style="height:${fn:length(impQpList)*40 + 120 - (fn:length(impQpList)-1)*10}px"></div></td>
		<td width="33%" style="vertical-align:top;"><div id="mainNumTwo" style="height:${fn:length(depList)*40 + 120 - (fn:length(depList)-1)*10}px"></div></td>
		<td width="33%" style="vertical-align:top;"><div id="mainNumThree" style="height:${fn:length(respList)*40 + 120 - (fn:length(respList)-1)*10}px"></div></td>
</tr>
</table>
</form>
</body>
