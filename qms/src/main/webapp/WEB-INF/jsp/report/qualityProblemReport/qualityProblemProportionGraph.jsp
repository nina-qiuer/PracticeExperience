    ...
    function (ec) {
    	...
    	if(viewFlag ==1){
	        ...
	        if(qpType==1){
	        	 ...
	        	 qpTypeName = "质量问题一级占比";
	        	 qpTypeNameRank ="质量成本一级总数";
	        }else if(qpType==2){
	        	
	        	 qpTypeName = "质量问题二级占比";
	        	 qpTypeNameRank ="质量成本二级总数";
	        	
	        }else if(qpType==3){
	        	
	        	 qpTypeName = "质量问题三级占比";
	        	 qpTypeNameRank ="质量成本三级总数";
	        }
    	}else if(viewFlag==2) {
	        ...
	        if(depType==1){
	        	...
	        	qpTypeName = "三级责任部门占比";
	        	qpTypeNameRank ="三级责任部门总数";
	        }
    	}
		else if(viewFlag==3) {
		    		
			qpTypeName="责任岗位占比";	
			qpTypeNameRank ="责任岗位总数";
		 }
		else if(viewFlag==4) {
			
			qpTypeName="供应商占比";	
			qpTypeNameRank ="供应商总数";
		}
		else if(viewFlag==5) {
			
			qpTypeName="责任人占比";	
			qpTypeNameRank ="责任人总数";
		}
...
function search() {
	...
	$("#dataForm").attr("action", "report/qualityProblemReport/qualityProblemProportion");
	$("#dataForm").submit();
}
</script>
</head>
...
<table width="100%" class="search">
				<tr>
				   ...
				   <td>
					...
					<td colspan="4">
						<div id="radioset">
							<form:radiobutton path="dto.viewFlag" value="1" label="问题类型" />
							<form:radiobutton path="dto.viewFlag" value="2" label="责任部门" />
							<form:radiobutton path="dto.viewFlag" value="3" label="责任岗位" />
							<form:radiobutton path="dto.viewFlag" value="4" label="供应商" />
							<form:radiobutton path="dto.viewFlag" value="5" label="责任人" />
						</div>
				</td>
				</tr>
				<tr>
