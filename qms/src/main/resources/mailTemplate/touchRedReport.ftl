...
<body>
	<div class="main_div">
		<table class="datatable" style="border:1px solid lightblue">
			<!-- touchRedTitle -->
			<tr>
			   <td colspan='10' align='center'>触红下线通知</td>
			</tr>
			<tr>
			...
			<td colspan="9"  style='color:red;'>
				<p>当产品第1次达不到触红要求时，产品下线整改时间为7天</p><p>当产品第2次达不到触红要求时，产品下线整改时间为15天；</p><p>当产品第3次达不到触红要求时，产品下线整改时间为30天；</p><p>当产品第4次达不到触红要求时，产品永久下线。</p>
			</td>
			</tr>
			<#if complaintBill.id??>
			<tr>
