...
public class POIUtil<T> {
	 ...
	 */          
	public void exportExcel(List<String> headers, List<String> exportFields,String fileName,
			Collection<T> dataset,CellDataMapperHandler  cellDataMapperHandler,HttpServletResponse response)
			throws Exception {
