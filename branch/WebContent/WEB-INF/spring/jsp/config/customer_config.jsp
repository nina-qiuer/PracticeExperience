...
<script type="text/javascript">
	...
	function add(){
		...
		$.ajax({
			type:"post",
			url:'add',
			data:{'dataId':dataId.value, 'content':$('#content').val(),'description':description.value,'config_level':1},
			success:function(){
				alert('添加成功');
				$("#search_form").submit();
			}
...
<BODY>
<form name="form" id="search_form" method="post"  action="customer_config">
        配置键：
