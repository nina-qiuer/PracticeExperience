					...
					<table style="width: 850px;border-collapse: collapse;border: 2px solid #99bbe8;margin: auto;table-layout: fixed;">
						<tbody>
							<tr>
								...
								<th style="width:7%;border: 2px solid #99bbe8;text-align: center;">订单号</th>
								<th style="width:7%;border: 2px solid #99bbe8;text-align: center;">线路编号</th>
								...
								<th style="width:30%;border: 2px solid #99bbe8;text-align: center;">整体评价</th>
								<th style="width:30%;border: 2px solid #99bbe8;text-align: center;">分项评价</th>
							</tr>
