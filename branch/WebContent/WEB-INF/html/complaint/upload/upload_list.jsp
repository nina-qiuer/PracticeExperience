...
<table class="listtable" width="98%">
	...
	<tbody>
		...
		<tr align="center">
			...
			<c:if test="${type=='act' }">
			<td>
				<a href="complaint-delToolFile?attachId=${v.id}&complaintId=${v.complaintId}" onclick="return confirm('本操作不可恢复,确认删除?')">删除</a> 
			</td>
			</c:if>
		</tr>
		</c:forEach>
...
<form id="upload" action="complaint-upload" enctype="multipart/form-data" method="post">
