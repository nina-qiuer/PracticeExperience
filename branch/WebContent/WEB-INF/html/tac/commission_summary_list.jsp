...
<script type="text/javascript">
	var modelName='提成汇总';
	var mainUrl = 'commissionSummary';
</script>

</head>
<body>
<div class="top_crumbs">您当前所在的位置：投诉质检管理>><span class="top_crumbs_txt">提成汇总列表</span></div>
<div  class="main">
<form name="form" id="search_form" method="post" enctype="multipart/form-data" action="commissionSummary">
    <div class="pici_search pd5 mb10">
        <label class="mr10">类别：
        	<s:select list="categorys" headerKey=""  headerValue="--"  name="searchVo.category"></s:select>
        </label>
        <label class="mr10">客服：
...
<table width="100%" class="listtable mb10">
    ...
    <c:forEach items="${dataList}" var="v">
        <tr>
            ...
            <td>${v.customer}</td>
            <td>${v.category}</td>
            <td class="shorten30">${v.remark}</td>
            <td>
