...
<title>质检报告</title>
<link type="text/css" href="waitforconvertcss/bui.css"
	rel="stylesheet" />
<style type="text/css">
.common-box {
	...
	<div class="common-box">
		...
		<table width="100%" class="datatable">
			<tr>
				...
				<td colspan="5">waitforconvert</td>
			</tr>
			<tr>
				<th width="100" align="right">订单号：</th>
				<td>waitforconvert</td>
			...
			<tr>
				...
				<td colspan="3">waitforconvert</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>waitforconvert</td>
				<th align="right">客服高级经理：</th>
				<td>waitforconvert</td>
			</tr>
			<tr>
				<th align="right">产品人员：</th>
				<td>waitforconvert</td>
				<th align="right">产品主管：</th>
				<td>waitforconvert</td>
	...
	<div class="common-box">
		...
		<table width="100%" class="datatable">
			...
			<tr>
				...
				<td id="responsibility">waitforconvert</td>
			</tr>
			
			<tr>
				<th align="right">执行岗位：</th>
				<td id="position">waitforconvert</td>
			</tr>
