...
public class ComplaintXmlrpcBase extends WebServiceBase {
	...
	public Object decodeMsg(String encodeMsg) throws IllegalAccessException, UnsupportedEncodingException {
		...
		try{
			...
			if(!jsonObject.containsKey("data")) {
				...
				msg.data = PHPSerializer.unserialize(URLDecoder.decode(jsonObject.getString("data"),"UTF-8").getBytes());
				if(jsonObject.containsKey("extra_data")) {
					msg.extraData = PHPSerializer.unserialize(URLDecoder.decode(jsonObject.getString("extra_data"),"UTF-8").getBytes());
				} else {
					msg.extraData = null;
				}
