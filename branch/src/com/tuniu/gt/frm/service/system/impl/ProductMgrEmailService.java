...
@Service
public class ProductMgrEmailService implements IEmailService {
	...
	public List<String> getReceiverEmails(ComplaintEntity entity) {
		...
		if (StringUtil.isNotEmpty(entity.getProductLeader())) {
			recipients = userService.getUsers("realNames", "'" + entity.getProductLeader() + "'");
		}
