...
@Service
public class ProductSeniorMgrEmailService implements IEmailService {
	...
	public List<String> getReceiverEmails(ComplaintEntity entity) {
		...
		if (StringUtil.isNotEmpty(entity.getSeniorManager())) {
			recipients = userService.getUsers("realNames", "'" + entity.getSeniorManager() + "'");
		}
