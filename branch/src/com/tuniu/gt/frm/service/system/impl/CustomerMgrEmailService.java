...
@Service
public class CustomerMgrEmailService implements IEmailService {
	...
	public List<String> getReceiverEmails(ComplaintEntity entity) {
		...
		if (StringUtil.isNotEmpty(entity.getCustomerLeader())) {
			recipients = userService.getUsers("realNames", "'" + entity.getCustomerLeader() + "'");
		}
