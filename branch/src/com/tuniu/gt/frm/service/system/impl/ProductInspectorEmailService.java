...
@Service
public class ProductInspectorEmailService implements IEmailService {
	...
	public List<String> getReceiverEmails(ComplaintEntity entity) {
		...
		if (StringUtil.isNotEmpty(entity.getProductManager())) {
			recipients = userService.getUsers("realNames", "'" + entity.getProductManager() + "'");
		}
