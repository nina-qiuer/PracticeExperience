...
@Service
public class OperationInspectorEmailService implements IEmailService {
	...
	public List<String> getReceiverEmails(ComplaintEntity entity) {
		...
		if (StringUtil.isNotEmpty(entity.getOperateManagerName())) {
			...
			UserEntity inspector = ComplaintRestClient.getReporter(usr.getRealName());
			emails.add(inspector.getEmail());
		}
		return emails;
	}
