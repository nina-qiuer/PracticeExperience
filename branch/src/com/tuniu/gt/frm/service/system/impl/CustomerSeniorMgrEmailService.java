...
@Service
public class CustomerSeniorMgrEmailService implements IEmailService {
	...
	public List<String> getReceiverEmails(ComplaintEntity entity) {
		...
		if (StringUtil.isNotEmpty(entity.getServiceManager())) {
			recipients = userService.getUsers("realNames", "'" + entity.getServiceManager() + "'");
		}
