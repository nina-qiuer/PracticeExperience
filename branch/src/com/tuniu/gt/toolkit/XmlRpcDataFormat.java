...
public class XmlRpcDataFormat {
	...
	private static Logger logger = Logger.getLogger(XmlRpcDataFormat.class);
	...
	public static String encodeData(Map<String, Object> paramMap)
		...
		String data = XmlRpcDataFormat.encodeParams(paramMap);
		try {
	...
	public static String encodeData2(Map<String, Object> paramMap)
			throws Exception {
		String data = XmlRpcDataFormat.encodeParams2(paramMap);
		try {
			data = URLEncoder.encode(data, "UTF-8");
		} catch (UnsupportedEncodingException e) {
			throw e;
