package com.tuniu.bi.presatisfy.entity;
...
public class PresatisfyEntity extends EntityBase implements Serializable {
	...
	/**
	 * @return the staticDate
	 */
	public String getStaticDate() {
		return staticDate;
	}
	/**
	 * @param staticDate the staticDate to set
	 */
